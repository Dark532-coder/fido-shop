    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-xs text-slate-500">
          Paiements sécurisés par Mixx by Yas & Flooz
        </span>
      </div>
      ...
      {allOrders.length === 0 ? (
        <div className="py-12 text-center rounded-2xl border-2 border-dashed border-slate-200">
          ...
          <p className="text-xs text-slate-500 mt-1">
            Vos commandes payées par Mixx by Yas ou Flooz apparaîtront ici avec leur suivi en direct.
          </p>
        </div>
      ) : (
        <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center justify-between text-xs text-slate-600 pt-2 border-t border-slate-200">
                  ...
                  <div className="flex items-center gap-2 font-mono text-[11px]">
                    ...
                    <span className="font-bold text-slate-800">
                      {order.paymentMethod === 'yass' ? 'Mixx by Yas' : 'Flooz'}
                    </span>
